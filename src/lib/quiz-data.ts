// car-photos.generated.json is written by scripts/generate-car-manifest.mjs
// (runs before `npm run dev` / `npm run build`, or via `npm run generate:cars`).
// See public/cars/README.md for the photo naming convention.
...
// badge alone (S, T, 4, Turbo, etc). The GT3 and GT3 RS are the exception:
// their aero (wing, vents, ride height) is a genuine silhouette difference,
// and the 991 and 992 generations are listed separately.
export const MODELS: PorscheModel[] = [
  ...
  { id: "911-991-gt3", name: "911 GT3 (991)", angles: ALL_ANGLES },
  { id: "911-991-gt3-rs", name: "911 GT3 RS (991)", angles: ALL_ANGLES },
  { id: "911-992-gt3", name: "911 GT3 (992)", angles: ALL_ANGLES },
  { id: "911-992-gt3-rs", name: "911 GT3 RS (992)", angles: ALL_ANGLES },
