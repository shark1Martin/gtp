...
import { buildQuiz, type Question } from "@/lib/quiz-data";
        ...
        <main className="max-w-6xl mx-auto px-6 pt-12 pb-32 grid lg:grid-cols-[1fr_400px] gap-12 items-start">
          ...
          <section key={current} className="space-y-8 animate-entrance">
            <div className="relative">
              ...
              <div className="w-full aspect-[16/10] bg-zinc-900 overflow-hidden ring-1 ring-white/10">
                <img
                  src={q.answer.image}
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-white/40 text-lg leading-relaxed text-pretty">
                {phase === "revealed"
                  ? isCorrect
                    ? `Correct. ${q.answer.name} — ${q.answer.era}.`
                    : `Miss. This is a ${q.answer.name} (${q.answer.era}).`
                  : "Study the silhouette, wing geometry, and lamp cluster. Four candidates, one right answer."}
              </p>
            </div>
          </section>
